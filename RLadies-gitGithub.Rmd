...
- We can create other branch for other development.

--

- We can merge branches to the master branch.
...
IMPORTANT!!!!!
Any branch in your local repository is not available to others unless you push the branch to your remore repository, doing:
